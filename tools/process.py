...
parser.add_argument("--operation", required=True, choices=["grayscale", "resize", "blank", "combine", "edges", ", combine_color_binary"])
...
def combine_color_binary(src, src_path):
    if a.b_dir is None:
        raise Exception("missing b_dir")
...
def run_caffe(src):
    ...
    if net is None:
        ...
        net = caffe.Net("/data4T/liyh/projects/hed/examples/hed/deploy.prototxt", "/data4T/liyh/projects/hed/examples/hed/hed_pretrained_bsds.caffemodel", caffe.TEST)
