...
def parse_function(example_proto):
    """ parse images and mats from TFRecord and do data augmentation on them. """
    features = {
...
def read_tfrecord():
    ...
    #photo.set_shape([a.batch_size, 286, 286, 3])
    #mat.set_shape([a.batch_size, 286, 286, 3])
...
def main():
    ...
    with sv.managed_session() as sess:
        ...
        print("examples.steps_per_epoch: ", examples.steps_per_epoch)
        ...
        if a.mode == "test":
            ...
            for epoch in range(a.max_epochs):
                ...
                while True:
                    #print("step: ", step)
                    if step == examples.steps_per_epoch - 2:
                        break                
                    try:
                        def should(freq):
                            return freq > 0 and ((step + 1) % freq == 0 or step == examples.steps_per_epoch - 2)
                        options = None
                        run_metadata = None
